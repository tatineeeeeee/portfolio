  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-red-500/20 relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-red-500/10 rounded-full blur-xl animate-pulse opacity-50"></div>
        <div className="absolute top-3/4 right-1/4 w-24 h-24 bg-red-400/8 rounded-full blur-xl animate-pulse delay-1000 opacity-40"></div>
        <div className="absolute top-1/2 left-3/4 w-40 h-40 bg-red-600/6 rounded-full blur-xl animate-pulse delay-2000 opacity-30"></div>
        
        {/* Gradient Overlays */}
        <div className="absolute top-0 left-0 w-full h-1/3 bg-gradient-to-b from-red-950/20 to-transparent"></div>
        <div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-red-950/20 to-transparent"></div>
        
        {/* Interactive Mouse Follower */}
        <div 
          className="absolute w-96 h-96 bg-red-500/5 rounded-full blur-3xl transition-all duration-700 ease-out"
          style={{
        ...
        {/* Animated Lines */}
        <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-red-500/10 to-transparent animate-pulse"></div>
        <div className="absolute top-0 right-1/3 w-px h-full bg-gradient-to-b from-transparent via-red-400/8 to-transparent animate-pulse delay-1000"></div>
      </div>
      ...
      {/* Hero Section */}
      <section ref={heroRef} id="hero" className="pt-32 pb-20 px-6 relative">
        <div 
      ...
      {/* Tech Stack Section */}
      <section ref={skillsRef} id="skills" className="py-20 border-t border-slate-800/50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6 max-w-5xl mx-auto">
            {skills.map((skill, index) => (
              <div key={skill.name}
                   className="bg-slate-900/50 rounded-2xl p-6 border border-slate-800/50 hover:border-red-500/30 hover:bg-slate-900/70 transition-all duration-500 hover:scale-110 group translate-y-0 opacity-100"
      ...
      {/* Projects Section */}
      <section ref={projectsRef} id="projects" className="py-20 bg-slate-900/20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid gap-8">
            {projects.map((project, index) => (
              <div key={project.title}
                   className={`group ${project.highlight ? 'md:col-span-2' : ''} transition-all duration-700 translate-y-0 opacity-100`}
                ...
                <div className={`bg-slate-900/40 rounded-2xl border border-slate-800/50 overflow-hidden 
                                 ...
                                 ${project.highlight ? 'md:flex md:items-center' : 'p-6'}`}>
                  ...
                  {project.highlight ? (
                    ...
                    <>
                      ...
                      <div className="md:w-1/2 bg-slate-800/30 h-64 md:h-80 flex items-center justify-center">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {project.tech.map((tech) => (
                          <span key={tech} className="bg-slate-800/80 text-slate-300 px-2 py-1 rounded text-xs">
                            {tech}
                          </span>
                        ))}
                      </div>
      ...
      {/* Contact Section */}
      <section ref={contactRef} id="contact" className="py-20 px-6 bg-gradient-to-b from-transparent to-slate-900/10">
