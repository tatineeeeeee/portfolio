      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-red-500/20 relative overflow-x-hidden">
        ...
        >
          <div className="max-w-6xl mx-auto px-6">
            <div
              className={`text-center mb-16 transition-all duration-1000 ${visibleSections.has("skills") ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
            >
        ...
        <section ref={aboutRef} id="about" className="py-20 px-6 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div
              className={`text-center mb-16 transition-all duration-1000 ${visibleSections.has("about") ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
            >
            ...
            {/* Hero Statement */}
            <div
              className={`mb-16 text-center transition-all duration-1000 ${visibleSections.has("about") ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
            ...
            {/* Main Content Grid */}
            <div
              className={`grid lg:grid-cols-2 gap-12 mb-16 transition-all duration-1000 ${visibleSections.has("about") ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
                  ...
                  <div className="bg-gradient-to-br from-slate-900/60 to-slate-800/60 rounded-2xl p-8 border border-slate-700/50 hover:border-red-500/30 transition-all duration-500 hover:shadow-xl hover:shadow-red-500/10 hover:-translate-y-1">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {[
                        ...
                        <div
                          key={skill}
                          className="flex items-center group/item hover:scale-105 transition-transform duration-200"
                        >
                          <div className="w-2 h-2 bg-red-400 rounded-full mr-3 group-hover/item:bg-red-300"></div>
                          <span className="text-slate-300 group-hover/item:text-red-300 transition-colors">
                            {skill}
                          </span>
                        </div>
                      ))}
        ...
        >
          <div className="max-w-6xl mx-auto">
            <div
              className={`text-center mb-16 transition-all duration-1000 ${visibleSections.has("projects") ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
            >
              <h2 className="text-3xl font-bold mb-4">Featured Work</h2>
              <p className="text-slate-400 max-w-2xl mx-auto">
                A selection of projects that showcase my skills and growth as a
                developer
              </p>
            </div>
                  ...
                  >
                    {project.highlight ? (
                      ...
                      <>
                        <div className="md:w-1/2 p-8">
                          ...
                          <div className="flex flex-wrap gap-2 mb-6">
                            {project.tech.map((tech) => (
                              <span
                                key={tech}
                                className="bg-slate-800/80 text-slate-300 px-3 py-1 rounded-full text-sm"
                              >
                                {tech}
                              </span>
                            ))}
                        ...
                        <div
                          className="md:w-1/2 h-64 md:h-full min-h-[280px] relative overflow-hidden cursor-pointer"
                      ...
                      // Regular project layout with image
                      <div className="flex flex-col md:flex-row">
                        {/* Project Image */}
                        <div
                          className="md:w-2/5 h-48 md:h-auto min-h-[200px] relative overflow-hidden cursor-pointer"
                          onClick={() => setLightboxImage(project.image)}
                        >
                          <Image
                            src={project.image}
        ...
        >
          <div className="max-w-4xl mx-auto">
            <div
              className={`text-center mb-16 transition-all duration-1000 ${visibleSections.has("contact") ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
            >
