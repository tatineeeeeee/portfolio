      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <ScrollReveal delay={0.1}>
            <div className="bg-slate-900/30 rounded-2xl p-8 border border-slate-800/50 hover:border-red-500/30 transition-all duration-300 hover:bg-slate-900/50 h-full">
