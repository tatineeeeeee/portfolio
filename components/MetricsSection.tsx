        ...
        <StaggerContainer className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-5xl mx-auto">
          {metrics.map((metric) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-gradient-to-br from-red-900/20 to-red-800/20 rounded-2xl p-6 border border-red-500/20 hover:border-red-400/40 transition-all duration-500 hover:shadow-xl hover:shadow-red-500/20 hover:-translate-y-1 text-center h-full">
                <div className="text-3xl font-bold text-red-400 mb-1 group-hover:scale-110 transition-transform duration-300">
                  {metric.value}
                </div>
